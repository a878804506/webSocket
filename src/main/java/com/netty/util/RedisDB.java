...
public class RedisDB {
	...
	/*最小连接数*/
	private static int minIdle = Integer.parseInt(Configuration.propMap.get("redis.minIdle"));
	/*最大空闲等待数*/
	...
	/*聊天记录存放在第一个redis库*/
	public static int dbSelectedForHistoryMessage = Integer.parseInt(Configuration.propMap.get("redis.dbSelectedForHistoryMessage"));
	/*系统相关信息存放第二个redis库*/
	public static int dbSelectedForSystem = Integer.parseInt(Configuration.propMap.get("redis.dbSelectedForSystem"));
	/*所有系统用户再存入redis时的key*/
	public static String systemUsers = Configuration.propMap.get("redis.systemUsers");
